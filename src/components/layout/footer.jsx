...
const FOOTER_COLUMNS = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "Contribuir com o projeto",
        href: "/contribuir",
      },
      {
...
// Linha tracejada estilo "estrada"
const roadRuleTop = {
  height: 3,
  width: "100%",
...
const SocialIcon = ({ href, label, children, ...props }) => (
  <a
    ...
    className="flex h-8 w-8 items-center justify-center rounded-md border transition-colors hover:!border-[#5C6478] hover:!text-[#EDF0F5]"
  >
    {children}
  </a>
);
...
const Footer = ({ year = new Date().getFullYear() }) => {
  return (
    ...
    >
      {/* Linha superior */}
      <div style={roadRuleTop} aria-hidden="true" />
      ...
      <div className="mx-auto max-w-[1180px] px-6 pt-14">
        ...
        <div className="grid grid-cols-1 gap-10 pb-11 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <p
              ...
              className="mb-3.5 mt-2.5 text-[11px] font-semibold uppercase tracking-[0.12em]"
            >
            ...
            <p
              ...
              className="mb-5 max-w-[320px] text-sm leading-relaxed"
            >
              Roadmaps, aulas e projetos práticos para você sair do zero e
              chegar lá — sem pagar nada por isso. DevRoad é 100% gratuito e
              open source.
            </p>
        ...
        {/* Linha inferior */}
        <div style={roadRuleSubtle} aria-hidden="true" />
