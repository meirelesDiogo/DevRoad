...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description:
      aulaData.descricao ||
      `Aprenda ${aulaData.titulo} no curso de Python do DevRoad.`,
  };
}

export default async function AulaPythonPage({ params }) {
  ...
  const aulaProxima =
    indiceAtual >= 0 &&
    indiceAtual < aulasDoModulo.length - 1
      ...
      <div className="lesson-page">
        <header className="lesson-header">
          <div className="header-content">
            <Link href="/roadmaps/python" className="logo">
              Dev<span>Road</span>
            </Link>

            <Link href="/roadmaps/python" className="back-link">
