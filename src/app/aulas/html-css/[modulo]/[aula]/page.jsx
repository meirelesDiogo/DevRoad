...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description:
      aulaData.descricao ||
      `${aulaData.titulo} - HTML & CSS | DevRoad`,
  };
}
...
export default async function AulaPage({ params }) {
  ...
  const aulaAnterior = aulasDoModulo
  ...
  const proximaAula = aulasDoModulo
    .filter((item) => item.ordem > aulaData.ordem)
  ...
  const roadmapUrl = "/roadmaps/html-css";
