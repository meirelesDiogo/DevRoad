# DevRoad Code of Conduct

## Our Pledge

We as members, contributors, and maintainers of DevRoad pledge to make
...
welcoming, diverse, inclusive, and healthy community — especially because
DevRoad exists to help **beginners**, and no one should ever feel bad for
not knowing something yet.
...
- Focusing on what is best not just for us as individuals, but for the
  overall community
- Being patient with people who are learning — everyone started at zero
  at some point
...
- Mocking or belittling someone for not knowing something technical
...
repository, Discord server, official social media) and also applies when
an individual is officially representing the project in public spaces
(e.g. using an official project e-mail address, posting via an official
...
reported to the maintainers responsible for enforcement through:

- **Discord:** direct message to the moderation team (🛡️ Moderator role)
- **Email:** [meirelesdiogo.dev@gmail.com]
- **GitHub:** by opening a private security issue if available, or
...
public or private interaction with the people involved is allowed during
